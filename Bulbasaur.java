/**
* This class crates a pokemon named Bulbasaur that imbibes the behaviour of type Grass and implements pokemon class.
*/
public class Bulbasaur extends Pokemon implements Grass {
  /** Constructor
  * Initializes the pokemon, Bulbasaur.
  */
  public Bulbasaur(){
      super("Bulbasaur");
  ...
  /**
  * Description : This function gives all the names of special attacks.
  ...
  */
  public String razorLeaf(Pokemon p){
      ...
      p.takeDamage(damage);
      return p.getName() + " is  by RAZOR LEAF and takes "+ damage + " damage.";
  }
  /**
